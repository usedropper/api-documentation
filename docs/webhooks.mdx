...
while webhooks only make network requests when there is new information. 
...
You'll typically listen to these events on a `POST` endpoint called your **webhook URL**. <sub><sup><a href="https://medium.com/hookdeck/webhooks-explained-what-are-webhooks-and-how-do-they-work-90c613c055a4">Read more...</a></sup></sub>
